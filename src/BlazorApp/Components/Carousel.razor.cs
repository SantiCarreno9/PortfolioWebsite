...
namespace BlazorApp.Components
{
    public partial class Carousel
    {
        ...
        private async Task ScrollLeft()
        {
            ...
            //await JSRuntime.InvokeVoidAsync("scrollElement", scrollerReference, -1);
        }
        ...
        private async Task ScrollRight()
        {
            ...
            await ScrollTo(nextPosition);
            //await JSRuntime.InvokeVoidAsync("scrollElement", scrollerReference, 1); // Adjust scroll amount as needed
        }
